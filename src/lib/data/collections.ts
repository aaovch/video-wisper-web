		...
		analysis: {
			...
			findings: [
				...
				},
				{
					...
					reality:
						'В учебных и контролируемых эпизодах картинка действительно складывалась, а атаки «сферами» катаны сами собой оказались невыгодны — как и рассчитывали. Но в равных боях чаще решали уколы, удары в руку и кумулятивный набор, а не «киношные» порезы: пока порез — скорее премиальный приём, чем основа боя.'
				},
				{
